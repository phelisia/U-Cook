...
class CuisineFragment : Fragment() {
    ...
    fun displayTrendingImage() {
        binding.rvcuisine.layoutManager = GridLayoutManager(requireContext(), 2)
        binding.rvcuisine.adapter = HomeAdapter(listeners,createHomeImageList())
    }
